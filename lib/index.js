  ...
  render() {
    ...
    return (
      <View style={[styles.container, this.props.style]}>
        <View style={{ backgroundColor: '#efefef', padding: 10, borderRadius: 10, height: 50, justifyContent: 'center' }}>
        ...
        <View style={{ flex: 1, backgroundColor: '#efefef', borderRadius: 10, marginLeft: this.props.offset || 10 }}>
          <TextComponent
            ref={ref => {
              this.inputPhone = ref;
            }}
